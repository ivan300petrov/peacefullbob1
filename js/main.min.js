...
for (var i = 0; i < galleryItems.length; i++) {
    ...
    galleryItems[i].addEventListener("click", function showPhoto(e) {
        ...
        //слик--------------------------------
         galleryPopupImage.addEventListener(eventTouchMove, function(e) {
            e.preventDefault();
            moveX = width >= 1366 ? e.clientX : e.changedTouches[0].clientX;
if (mouseMoves) {galleryPopupImage.style.transform = `translateX(${(moveX - startX)/2 + 'px'})`;
galleryPopupImage.style.animation = '';
}
            console.log("moveX=", moveX, startX);
        });
         galleryPopupImage.addEventListener(eventTouchStart, function(e) {
mouseMoves = true;
            startX = width >= 1366 ? e.clientX : e.changedTouches[0].clientX;
        });

        galleryPopupImage.addEventListener(eventTouchEnd, function(e) {
            e.preventDefault();
            mouseMoves = false;
            ...
            console.log("moveback=", deltaX);
                    ...
                    galleryPopupImage.style.animation = 'moveback  500ms 1 ease-in-out';

                    galleryPopupImage.style.transform = 'translateX(0px)';
                }

            console.log("style=",  galleryPopupImage.style.animation);
            console.log("style=",  galleryPopupImage.style.transform);
        });
        // -------------------------------------
    });
}
