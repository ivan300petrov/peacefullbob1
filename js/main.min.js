...
for (var i = 0; i < galleryItems.length; i++) {
    ...
    galleryItems[i].addEventListener("click", function showPhoto(e) {
        ...
        console.log("moveto!");
        galleryPopupImage.addEventListener("mousedown", function(e) {
            _startX = e.changedTouches[0].clientX; // e.clientX;
            console.log("startto", _startX);
        });
        galleryPopupImage.addEventListener("mouseup", function(e) {
            var _endX = e.changedTouches[0].clientX,
                //e.clientX

                _deltaX = _endX - _startX;
            console.log(_deltaX, "moveto", "_deltaX =", _endX, " - ", _startX);
